    ...
    <footer className="px-8 py-12 bg-black text-orange text-xl uppercase">
      <div className="sm:flex sm:items-center sm:justify-between">
        ...
        <form>
          ...
          <div className="grid xl:grid-cols-2 xl:gap-36">
            ...
            <div className="relative z-0 mb-6 w-full group">
            <button type="submit" className=" bg-black hover:bg-orange hover:text-black rounded-full  w-full sm:w-auto px-8 py-1 text-center hover:transition-all">Send</button>
            </div>
