...
export default function Navbar() {
    return (
        <nav className="p-3.5 bg-black" >
            <div className=" flex justify-between xs:justify-center items-center">
                <button data-collapse-toggle="mobile-menu" type="button" className="inline-flex items-end mr-3 md:hidden" aria-controls="mobile-menu" aria-expanded="false">
